...
export function AppShell() {const [sidebarOpen, setSidebarOpen] = useState(false);

 const toggleSidebar = useCallback(() => {setSidebarOpen((prev) =>!prev);}, []);

 const closeSidebar = useCallback(() => {setSidebarOpen(false);}, []);

 return (<div className="flex w-full min-h-dvh">
 {/* Mobile overlay */}
 {sidebarOpen && (<div
 ...
 <span className="text-sm font-semibold" style={{color: 'var(--color-primary)'}}>Hướng dẫn sử dụng Bardic</span>
 </div>
