...
window.addEventListener('error', (event) => {const msg = event.error?.message || event.message || '';
 if (msg.includes('removeChild') ||
 msg.includes('insertBefore') ||
 msg.includes('not a child of this node')) {console.warn('[GlobalErrorHandler] DOM reconciliation error detected, auto-reloading in 500ms');
