...
if (process.env.VERCEL) {// On Vercel, static files are handled by the CDN (vercel.json routes)
 // Only export the app for API routes} else {// Local or Docker: serve static files from dist/
